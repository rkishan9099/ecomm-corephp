            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                            <li>
                            <a href="product.php">
                                <i class="fas fa-map-marker-alt"></i>Product</a>
                        </li>
                        <li>
                            <a href="category.php">
                        ...
                        <li>
                            <a href="colors.php">
                                <i class="material-icons">color_lens</i> Colour</a>
                        </li>
                        <li>
                            <a href="sizes.php">
                                <i class=""></i>Sizes</a>
                        ...
                        <li>
                            <a href="banner.php">
                                <i class="fa fa-get-pocket"></i>Banner</a>
                        </li>
                        <li>
                            <a href="brands.php">
                                <i class="fa fa-get-pocket"></i>Brands</a>
                        </li>
